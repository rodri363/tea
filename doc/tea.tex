...
drawing from nonmissing values in the same subset. The assumption underlying the
model is {\em missingness completely at random} (MAR), meaning that nonrespondents
are in no way different from respondents.
