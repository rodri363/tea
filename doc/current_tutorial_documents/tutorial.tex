...
A visual layout of the {\tt keys} file is shown below. If this all seems confusing, do not fret. The layout of the {\tt spec} file will make more sense as we continue to explain its various features. Again, more information about these keys can be found in the appendix.\\

\begin{figure}[H]
\begin{center}
\includegraphics[scale=.5]{dotInput.png}
\caption{input \{ $\ldots$ \} flow chart}\label{afigure}
\end{center}
\end{figure}
...
Here is a visual representation of the {\tt recodes} key:

\begin{figure}[H]
\begin{center}
\includegraphics[scale=.5]{dotRecodes.png}
\caption{records \{ $\ldots$ \} flow chart}\label{afigure}
\end{center}
\end{figure}
...
Here is a visual representation of the {\tt checks} key and all of its subkeys:

\begin{figure}[H]
\begin{center}
\includegraphics[scale=.5]{dotChecks.png}
\caption{checks \{ ... \} key flow chart}
\end{center}
\end{figure}
...
\caption{impute \{ ... \} key flow chart.}\label{afigure}
\end{center}
\end{figure}
...
\comment{ %BK: All of raking is commented out. 
...
\comment{DV: We need to add rel to this list.}
...
\comment{%BK: Not sure how much of this still works.
